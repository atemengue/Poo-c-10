...
internal class Utilities
{
    ...
    {
        Console.WriteLine($"Enter the new stock threshold (current value: {Product.StockThresold}). This applies to all products!");
        Console.Write("New value: ");
        int newValue = int.Parse(Console.ReadLine() ?? "0");
        Product.StockThresold = newValue;
        Console.WriteLine($"New stock threshold set to {Product.StockThresold}");
